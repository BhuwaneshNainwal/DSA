...
/*
	(a * b) % m = 1 => b is multiplicative modulo inverse of a wrt m
	(a * b - 1 ) % m = 0
	a * b - 1 = k1 * m
	a * b - k1 * m = 1;
	a * b + m * k = 1;
	This holds iff gcd(a , m) = 1 
	
	Alternatively,
	According to Euler's theorem,
	a ^ phi(m) = 1 (mod m) , if a and m are coprime

	if m is prime,
	It turned into Fermat's little theorem,
	a ^ (m - 1) = 1 (mod m)
	so, a ^ (m - 2) = a ^ -1 (mod m)
*/
