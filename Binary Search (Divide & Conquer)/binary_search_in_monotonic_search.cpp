...
/*
	TC - O(log n)
	Here we are applying binary search on monotonic search space.
	we want to get that maximum value in search space for which out answer is true.
...
float square_root(int n)
{
	...
	//Floating part using bruteforce approach
	float inc = 0.1;
	int p = 3;
	for(int i = 0 ; i < p - 1 ; i++)
	{
