...
/* Segmented sieve approach comes into picture when we to find primes
in the greater than 1e8 since largest sieve array we can make in sieve
of eratosthenes is 1e8
*/
