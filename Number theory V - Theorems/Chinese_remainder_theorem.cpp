...
/*
	x = summation i = 0 to i = k - 1 over(rem[i] * pp[i] * inv[i]) % product
	where product = product of numbers in num array , pp[i] = product / ith number in num array
	and inv[i] = modulo multiplicative inverse of pp[i] wrt num[i].
*/
