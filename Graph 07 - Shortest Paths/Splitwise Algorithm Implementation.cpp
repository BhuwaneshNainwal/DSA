...
/*
	The goal of this algorithm is to do settlement in minimum number of transactions.
...
void solve()
{
	...
	//Pop out elements from left and right
	...
	while(!m.empty())
	{
		...
		//Settlement amount from donar to acceptor
		debit += settlement;
		credit -= settlement;
