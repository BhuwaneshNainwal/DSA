...
void solve()
{
    ...
    //x is probability of two people having different birthday
    float x = 1.0;

    int num = 365;
    int denom = 365;

    //p is the probabilty of two people having same birthday

    if(p == 1.0)
    {
        //That many people must be there
        cout << "people : 366" << "\n";
        return;
    }
    while(x > 1 - p)
