...
/*
	...
	We do coordinate compression method whenever we have to deal with negative numbers int the array or the numbers
	is very large.

	original array => 100 99 82 11 97
	Doing coordinate compression	
	Modified array => 5  4   2  1  3
