...
// dp[i][j] => maximum points till ith day and considering jth activity on ith day
...
void solve()
{
	...
	// cout << max3(a[0] + maximizePoints(1 , 'a') , b[0] + maximizePoints(1 , 'b') , c[0] + maximizePoints(1 , 'c'));
	cout <<maximizePoints();
}
