...
/* O(n log n) based on division  query property */
...
int bit[102][102][102] = {{0} , {0} , {0}};
int arr[102][102][102] = {{0} , {0} , {0}};
...
{
        int j4 = query(x1-1, y1-1, z1-1);
        int j1 = query(x2, y1-1, z1-1) - j4;
        int j2 = query(x1-1, y2, z1-1) - j4;
        int j3 = query(x1-1, y1-1, z2) - j4;

        return query(x2, y2, z2) - query(x2, y1-1, z2) - query(x1-1, y2, z2) - query(x2, y2, z1-1) + 2*j4 + j1 + j2 + j3;
