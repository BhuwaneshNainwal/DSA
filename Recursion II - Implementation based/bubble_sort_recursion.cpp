...
void bubble_sort(int *arr , int n)
{
	...
	//outer loop working as recursion
	bubble_sort(arr , n - 1);
}
...
void bubble_sort_recursive(int *arr , int j , int n)
{
	...
	//Largest element of current array gets to the right position
	//Working as outer loop
	if(j == n - 1)
