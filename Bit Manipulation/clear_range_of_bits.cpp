...
void clear_range_of_bits_inbetween(int &n, int i, int j)
{
    int ones = ~0;
    int a = ones << (j + 1);
    // Since 2 ^ n - 1
...
//Clearing i bits from right
void clear_range_of_bits(int &n, int i)
{
    int mask = (~0 << i);
...
void solve()
{
    ...
    cin >> n >> i;
    clear_range_of_bits(n, i);
    cout << n << "\n";
    
    cin >> n >> l >> r;

    clear_range_of_bits_inbetween(n, l, r);
    cout << n << "\n";
}
